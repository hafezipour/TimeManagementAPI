...
-- Description: Delete a shift trade request and associated shift assignments
-- =============================================

CREATE OR ALTER PROCEDURE [dbo].[usp_ShiftTrades_DeleteTradeRequest]
    @TradeRequestId INT,
    @TenantId INT
AS
BEGIN
