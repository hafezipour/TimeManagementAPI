...
public class HolidayAssignmentRepository
{
    ...
    /// </summary>
    public async Task<string> GetHolidayAssignments(string? holidayIds, int? jobCodeId, int? userId, string? searchStr, string? assignmentBy, int offset, int limit, int tenantId)
    {
        try
        {
            List<SqlParameterModel> param = new List<SqlParameterModel>()
            {
                ...
                new SqlParameterModel(){ Name = "AssignmentBy", Value = assignmentBy ?? ""},
